6.0.0 - adding an optional .gbDivision property to tgJson and always including a DIVISION property on exported genbank files (https://www.ncbi.nlm.nih.gov/Sitemap/samplerecord.html#GenBankDivisionB)
