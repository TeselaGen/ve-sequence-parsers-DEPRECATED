...
var _NameUtils = require("./NameUtils.js");

var _NameUtils2 = _interopRequireDefault(_NameUtils);

var _lodash = require("lodash");

var _pragmasAndTypes = require("./pragmasAndTypes.js");

var _pragmasAndTypes2 = _interopRequireDefault(_pragmasAndTypes);

var _parseUracilFeatures = require("./parseUracilFeatures.js");

var _parseUracilFeatures2 = _interopRequireDefault(_parseUracilFeatures);
...
function validateSequence(sequence) {
  ...
  if (reformatSeqName) {
    sequence.name = _NameUtils2.default.reformatName(sequence.name);
  }
  ...
  if (isProtein) {
    ...
    if (isOligo) {
      ...
      var newSeq = (0, _parseUracilFeatures2.default)(sequence.sequence, sequence.features);
  ...
  sequence.features = sequence.features.filter(function (feature) {
    ...
    if (!(0, _validate2.default)([feature.start]) || feature.start > sequence.size - (inclusive1BasedStart ? 0 : 1)) {
    ...
    if (!(0, _validate2.default)([feature.end]) || feature.end > sequence.size - (inclusive1BasedEnd ? 0 : 1)) {
    ...
    if (!feature.type || typeof feature.type !== "string" || !_veSequenceUtils.FeatureTypes.some(function (featureType) {
    ...
    for (var _iterator = _pragmasAndTypes2.default, _isArray = Array.isArray(_iterator), _i = 0, _iterator = _isArray ? _iterator : _iterator[Symbol.iterator]();;) {
      var _ref2;
