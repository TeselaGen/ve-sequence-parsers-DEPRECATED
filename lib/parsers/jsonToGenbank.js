...
exports.default = function (_serSeq, options) {
  ...
  try {
    ...
    serSeq.features = (0, _lodash.map)(serSeq.features).concat((0, _lodash.flatMap)(serSeq.parts, function (p) {
      if (!(0, _lodash.isObject)(p)) {
        return [];
      }
    ...
    if (serSeq.primers) {
      serSeq.features = (0, _lodash.map)(serSeq.features).concat((0, _lodash.flatMap)(serSeq.primers, function (primer) {
        if (!(0, _lodash.isObject)(primer)) {
          return [];
        }
        return primer;
      }));
