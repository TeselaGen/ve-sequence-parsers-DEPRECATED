...
function genbankToJson(string, onFileParsedUnwrapped, options) {
  var onFileParsed = function onFileParsed(sequences, options) {
    ...
    var sequenceData = (0, _validateSequenceArray2.default)((0, _flattenSequenceArray2.default)(sequences, options), options);
  ...
  try {
    var lines = (0, _splitStringIntoLines2.default)(string);
    var LINETYPE = false;
  ...
  function parseLocus(line) {
    ...
    for (var _i = 1; _i < lineArr.length; _i++) {
      if (typeof lineArr[_i] === "string" && _constants.gbDivisions[lineArr[_i].toUpperCase()]) {
        gbDivision = lineArr[_i].toUpperCase();
      }
    }

    //don't use "exported as a file name unless it is out last option"
    if (locusName !== "Exported" || result.parsedSequence.name === _constants2.default.untitledSequenceName) {
...
exports.default = (0, _addPromiseOption2.default)(genbankToJson);
